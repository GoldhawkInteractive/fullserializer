...
namespace FullSerializer.Internal.DirectConverters {
    public class Bounds_DirectConverter : fsDirectConverter<Bounds> {
        protected override fsResult DoSerialize(Bounds model, Dictionary<string, fsData> serialized) {
            ...
            result += SerializeMember(serialized, "center", model.center, null);
            result += SerializeMember(serialized, "size", model.size, null);
        ...
        protected override fsResult DoDeserialize(Dictionary<string, fsData> data, ref Bounds model) {
            ...
            var t0 = model.center;
            result += DeserializeMember(data, "center", out t0, null);
            model.center = t0;

            var t1 = model.size;
            result += DeserializeMember(data, "size", out t1, null);
            model.size = t1;
